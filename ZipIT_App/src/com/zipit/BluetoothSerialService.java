...
public class BluetoothSerialService {
     ...
     */
    public synchronized void connect(BluetoothDevice device) throws InvocationTargetException {
  ...
  //      msg.setData(bundle);
   //      mHandler.sendMessage(msg);
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) throws InvocationTargetException {
            mmDevice = device;
            BluetoothSocket tmp = null;

            // TODO Esta parte del código de bluetoothchat no funciona con HC-05
         ...
         // TODO Esta parte funciona con HC-05
            Method m;
                        try {
